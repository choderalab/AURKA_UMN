...
# Launch job.
python ./pseudotorsion.py AURKA_phos_tpx2
python ./pseudotorsion.py AURKA_nophos_tpx2
python ./pseudotorsion.py AURKA_phos_notpx2
python ./pseudotorsion.py AURKA_nophos_notpx2
