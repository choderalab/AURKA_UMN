...
# Launch job.
python ./KERdistances.py AURKA_nophos_tpx2 AURKA
python ./KERdistances.py AURKA_nophos_notpx2 AURKA
python ./KERdistances.py AURKA_nophos_tpx2 AURKA_phos
python ./KERdistances.py AURKA_nophos_notpx2 AURKA_phos
