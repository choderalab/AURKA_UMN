...
solv = CharmmPsfFile('step2_solvator.psf')
...
solv.setBox(max_crds[0] - min_crds[0],
...
system = solv.createSystem(params, nonbondedMethod=app.PME,
...
sim = app.Simulation(solv.topology, system, integrator, platform, prop)
...
sim.reporters.append(app.DCDReporter('solv.dcd', 100))
