...
output_path = pdbid+output_identifier+"TPX2-TPOs"

# Source PDB
pdbfilename = 'TPX2'+output_identifier+'.pdb'

print("Source PDB filename: %s" % pdbfilename)
print("Output directory for mutations: %s" % output_path)

mutants = ['WT','Q185C','Q185L','Q185M','Q185N','Q185H','C247A','C247L']
...
psf_file = 'TPX2'+output_identifier+'.psf'
